// (1) Função para criar um elemento HTML do tipo SPAN.
...
// (2) Função para criar um elemento HTML do tipo TEXT INPUT.
...
// (3) Função para criar um elemento HTML do tipo SELECT.
...
// (4) Função para criar um elemento HTML do tipo FIELDSET.
...
// (5) Função para criar um elemento HTML do tipo CHECKBOX.
...
// (6) Função para cria um elemento HTML do tipo RADIO. 
...
// (7) Função para criar um elemento HTML do tipo TEXT AREA.
...
// (8) Função para criar um elemento HTML do tipo SUBMIT. 
...
//(9) Cria um elemento HTML do tipo BR (Quebra de Linhas).
var append_br = (el, n) => {
    if (n == undefined) n = 1;
